      ...
      <main className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          ...
          <div className="bg-card rounded-lg shadow-lg border border-border overflow-hidden">
            {/* Card accent - matches task card style */}
            ...
            <div className="p-8">
              ...
              <Button
                ...
                className="w-full h-12 text-base font-medium bg-card hover:bg-secondary text-card-foreground border border-border shadow-sm"
                variant="outline"
              >
                {isSigningIn ? (
          ...
          <div className="mt-8 grid grid-cols-3 gap-4">
            <div className="text-center">
              <div 
                ...
                style={{ backgroundColor: "var(--task-blue)" }}
              >
                <Kanban className="h-5 w-5" style={{ color: "var(--task-blue-border)" }} />
              </div>
            ...
            <div className="text-center">
              <div 
                className="inline-flex items-center justify-center w-10 h-10 rounded-lg mb-2"
                style={{ backgroundColor: "var(--task-green)" }}
              >
                <CheckSquare className="h-5 w-5" style={{ color: "var(--task-green-border)" }} />
              </div>
            ...
            <div className="text-center">
              <div 
                className="inline-flex items-center justify-center w-10 h-10 rounded-lg mb-2"
                style={{ backgroundColor: "var(--task-pink)" }}
              >
                <Users className="h-5 w-5" style={{ color: "var(--task-pink-border)" }} />
              </div>
